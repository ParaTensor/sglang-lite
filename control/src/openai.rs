...
//! Per architecture, broad OpenAI protocol normalization and multi-backend
//! gateway logic belong in an optional upstream such as Unigateway. Keep this
//! single-engine contract minimal.
//!
